...
import com.elinxer.springcloud.platform.security.token.RedisTemplateTokenStore;
import com.elinxer.springcloud.platform.security.token.ResJwtAccessTokenConverter;
...
public class TokenStoreConfig {
	...
	public static class JWTTokenConfig {
		...
		public JwtAccessTokenConverter jwtAccessTokenConverter(){
			...
			accessTokenConverter.setSigningKey("hxkj");

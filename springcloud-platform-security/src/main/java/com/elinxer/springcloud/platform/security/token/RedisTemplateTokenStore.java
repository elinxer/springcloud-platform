package com.elinxer.springcloud.platform.security.token;


import com.elinxer.springcloud.platform.security.entity.LoginAppUser;
import com.elinxer.springcloud.platform.security.serializer.DefaultSerializationStrategy;
...
public class RedisTemplateTokenStore implements TokenStore {
	...
	public OAuth2AccessToken getAccessToken(OAuth2Authentication authentication) {
		...
		System.out.println(Arrays.toString(serializeKey(AUTH_TO_ACCESS + key)));
		System.out.println(Arrays.toString((AUTH_TO_ACCESS + key).getBytes(StandardCharsets.UTF_8)));
		System.out.println(Arrays.toString(serializedKey));

...
import com.elinxer.springcloud.platform.security.interceptor.RestTemplateInterceptor;
...
//				.setKeepAliveStrategy(DefaultConnectionKeepAliveStrategy.INSTANCE) //使用请求Keep-Alive的值，没有的话永久有效
				//todo .setKeepAliveStrategy(new CustomConnectionKeepAliveStrategy()) // 自定义

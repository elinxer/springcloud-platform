 ...
 */
@Service
public class CacheServiceImpl implements com.elinxer.springcloud.platform.cache.CacheService {
    ...
    @Override
    public <V, K> String getCache(K key, com.elinxer.springcloud.platform.cache.Closure<V, K> closure) {
        return doGetCache(key, closure, this.timeout, this.timeUnit);
    }

    @Override
    public <V, K> String getCache(K key, com.elinxer.springcloud.platform.cache.Closure<V, K> closure, long timeout, TimeUnit timeUnit) {
    ...
    @Override
    public StringRedisTemplate getStrHandle() {
        return this.stringRedisTemplate;
    }

    private <K, V> String doGetCache(K key, com.elinxer.springcloud.platform.cache.Closure<V, K> closure, long timeout, TimeUnit timeUnit) {

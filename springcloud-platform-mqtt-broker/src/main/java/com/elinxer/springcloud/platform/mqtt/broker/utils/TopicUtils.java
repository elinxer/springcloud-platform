...
public class TopicUtils {
    ...
    /** @see com.elinxer.springcloud.platform.mqtt.broker.broker.handler.ProbeHandler#IN_MSG_SIZE */
    public static final String BROKER_RECEIVED_MSG = SYS_TOPIC_BROKER + "receivedMsg";
    /** @see com.elinxer.springcloud.platform.mqtt.broker.broker.handler.ProbeHandler#OUT_MSG_SIZE */

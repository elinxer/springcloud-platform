package com.elinxer.springcloud.platform.mqtt.broker;

import com.elinxer.springcloud.platform.mqtt.broker.broker.BrokerInitializer;
...
public class SpringcloudPlatformMqttBrokerApplication {

    public static void main(String[] args) throws InterruptedException {

        ConfigurableApplicationContext context = SpringApplication.run(SpringcloudPlatformMqttBrokerApplication.class, args);

        // Init check.
        mqttInitCheck(context);

        // start mqtt broker.
        context.getBean(BrokerInitializer.class).start();
     ...
     */
    private static void mqttInitCheck(ApplicationContext ctx) {

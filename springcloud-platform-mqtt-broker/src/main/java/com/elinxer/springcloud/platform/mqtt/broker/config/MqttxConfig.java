...
import com.elinxer.springcloud.platform.mqtt.broker.entity.TopicRateLimit;
...
@Data
@Component
@ConfigurationProperties(prefix = "com.hx.broker")
public class MqttxConfig {
    ...
    public static class Ssl {
         ...
         * keyStore 位置
         */
        private String keyServerStoreLocation = "ssl/kserver.keystore";

        private String trustKeyServerStoreLocation = "ssl/tserver.keystore";

        /**
         * keyStore 密码
         */
        private String keyServerPassword = "123456";

        private String trustKeyServerPassword = "123456";
     ...
     * 实现见 {@link com.elinxer.springcloud.platform.mqtt.broker.broker.handler.PublishHandler} <code>chooseClient(List,String)</code> 方法.
     */
    @Data
     ...
     * </ol>
     * topic 写死在 {@link com.elinxer.springcloud.platform.mqtt.broker.utils.TopicUtils}
     */
    @Data

...
import com.elinxer.springcloud.platform.mqtt.broker.entity.*;
...
import com.elinxer.springcloud.platform.mqtt.broker.utils.GlobalExecutor;
...
/**
 * {@link MqttMessageType#CONNECT} 消息处理器
 */
@Slf4j
...
public final class ConnectHandler extends AbstractMqttTopicSecureHandler {
    ...
    private void process0(ChannelHandlerContext ctx, MqttMessage msg, Authentication auth) {
        ...
        log.info("process0 heartbeat={}", heartbeat);
        if (heartbeat > 0) {
